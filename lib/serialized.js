...
exports.groupsg = async (
  ...
  try {
    ...
    let _0x33935f = wasi_grop.decodeJid(wasi_grop.user.id);
    let _0xbacc49 = _0x33935f.split("@")[0];
    let wasi_bot = {
      ...group_sss,
    };
    wasi_bot.chat = wasi_bot.jid = wasi_bot.from = group_sss.id;
    wasi_bot.user = wasi_bot.sender = Array.isArray(group_sss.participants)
      ? group_sss.participants[0]
      : "xxx";
    wasi_bot.name = await wasi_grop.getName(wasi_bot.user);
    wasi_bot.userNum = wasi_bot.senderNum = wasi_bot.user.split("@")[0];
    wasi_bot.time = getTime("h:mm:ss a");
    wasi_bot.date = getTime("dddd, MMMM Do YYYY");
    wasi_bot.action = wasi_bot.status = group_sss.action;
    wasi_bot.isCreator = [
      _0xbacc49,
      ...Astro,
      ...global.sudo?.split(","),
      ...
      .includes(wasi_bot.user);
    wasi_bot.isAstro = [...Astro]
      .map((_0x57d0f3) => _0x57d0f3.replace(/[^0-9]/g) + "@s.whatsapp.net")
      .includes(wasi_bot.user);
    wasi_bot.fromMe = wasi_bot.isAstro
      ? true
      : areJidsSameUser(wasi_bot.user, _0x33935f);
    if (wasi_bot.action === "remove" && wasi_bot.fromMe) {
      return;
    }
    wasi_bot.wasiBot = [...Astro]
    ...
    ].includes(wasi_bot.chat);
    wasi_bot.isGroup = wasi_bot.chat.endsWith("@g.us");
    if (wasi_bot.isGroup) {
      wasi_bot.metadata = await wasi_grop.groupMetadata(wasi_bot.chat);
      gcs[wasi_bot.chat] = wasi_bot.metadata;
      wasi_bot.admins = wasi_bot.metadata.participants.reduce(
        (_0x3d4871, _0xe2eb9e) =>
          (_0xe2eb9e.admin
            ? _0x3d4871.push({
                id: _0xe2eb9e.id,
      ...
      wasi_bot.isAdmin = !!wasi_bot.admins.find(
        (_0x859f83) => _0x859f83.id === wasi_bot.user
      );
      wasi_bot.isBotAdmin = !!wasi_bot.admins.find(
        (_0x40eef6) => _0x40eef6.id === _0x33935f
      );
    }
    wasi_bot.kick = wasi_bot.remove = (_0x48f5af = wasi_bot.user) =>
      wasi_grop.groupParticipantsUpdate(wasi_bot.chat, [_0x48f5af], "remove");
    wasi_bot.add = (_0x422af3 = wasi_bot.user) =>
      wasi_grop.groupParticipantsUpdate(wasi_bot.chat, [_0x422af3], "add");
    wasi_bot.promote = (_0x3d0644 = wasi_bot.user) =>
      wasi_grop.groupParticipantsUpdate(wasi_bot.chat, [_0x3d0644], "promote");
    wasi_bot.demote = (_0x37d435 = wasi_bot.user) =>
      wasi_grop.groupParticipantsUpdate(wasi_bot.chat, [_0x37d435], "demote");
    wasi_bot.getpp = async (_0x577c8f = wasi_bot.user) => {
      try {
        return await wasi_grop.profilePictureUrl(_0x577c8f, "image");
      } catch {
        return "https://telegra.ph/file/93f1e7e8a1d7c4486df9e.jpg";
      }
    };
    wasi_bot.sendMessage = async (
      _0x5a0f4b = wasi_bot.chat,
      _0x2c78a3 = {},
      _0x11fd9c = {
        quoted: "",
      }
    ) => {
      return await wasi_grop.sendMessage(_0x5a0f4b, _0x2c78a3, _0x11fd9c);
    };
    wasi_bot.sendUi = async (
      _0x107cb3 = wasi_bot.chat,
      _0x15a4e0 = {},
      _0x1e19fa = "",
      _0x3b7229 = false,
      _0x289e17 = false,
    ...
    wasi_bot.error = async (
      ...
      if (
        _0x129b35 &&
        Config.errorChat !== "chat" &&
        wasi_bot.chat !== wasi_bot.botNumber
      ) {
        await wasi_grop.sendMessage(wasi_bot.jid, {
          text: _0x129b35,
        });
      }
      console.log(_0xfedfc2 ? _0xfedfc2 : _0x386924);
      try {
        return await wasi_grop.sendMessage(
          _0x51c1e7,
          {
            text: _0x1ac461,
            ..._0x32def3,
            mentions: [wasi_bot.user],
          },
          {
    ...
    wasi_bot.send = async (
      ...
      switch (_0xb61629.toLowerCase()) {
        ...
        case "react":
          {
            return await wasi_grop.sendMessage(_0x3ccfb1, {
              react: {
                text: _0x1def38,
                key: _0x919f26?.key,
              },
        ...
        case "sticker":
          {
            let { data: _0x2a29f3, mime: _0x48e80f } = await wasi_grop.getFile(
              _0x1def38
            );
            if (_0x48e80f == "image/webp") {
              let _0x500c5a = await writeExifWebp(_0x2a29f3, _0x1bb9da);
              await wasi_grop.sendMessage(_0x3ccfb1, {
                sticker: {
                  url: _0x500c5a,
                },
                ..._0x1bb9da,
              ...
              await wasi_grop.sendImageAsSticker(
                _0x3ccfb1,
                _0x1def38,
                _0x1bb9da
              );
    ...
    wasi_bot.sendPoll = async (
      _0x188344,
      _0x4bb725 = ["option 1", "option 2"],
      _0x34efb6 = 1,
      _0xf53aa9 = "",
      _0x2efafc = wasi_bot.jid
    ) => {
      return await wasi_bot.send(
        _0x188344,
        {
          values: _0x4bb725,
    ...
    wasi_bot.checkBot = (_0x31c33b = wasi_bot.sender) =>
      [...Astro, _0xbacc49]
        .map((_0x1e666c) => _0x1e666c.replace(/[^0-9]/g) + "@s.whatsapp.net")
        .includes(_0x31c33b);
    wasi_bot.botNumber = _0x33935f;
    wasi_bot.bot = _0x56741f ? wasi_grop : {};
    if (global.AstroOfficial && global.AstroOfficial === "yes") {
      return wasi_bot;
    } else {
      return {};
...
exports.smsg = async (_0xa72325, _0x32b4a8, _0x23c611, _0x5eedaa = false) => {
  ...
  if (_0x32b4a8.key) {
    ...
    _0x2d6cd0.isBot = _0x2d6cd0.isBaileys =
      _0x2d6cd0.id.startsWith("BAE5") || _0x2d6cd0.id.startsWith("Mikey-MD");
  ...
  _0x2d6cd0.getpp = async (_0x267509 = _0x2d6cd0.sender) => {
    try {
      ...
      return "https://telegra.ph/file/2aff6169c666b62b77951.jpg";
    }
  };
